...
var newDateStartMode = function newDateStartMode(newDate, endDate, smartMode, startDate) {
  ...
  var newDateWithTime = createNewDateWithTime(newDate, startDate.hour(), startDate.minute());
...
var newDateEndMode = function newDateEndMode(newDate, startDate, smartMode, endDate) {
  ...
  // doesnt contain time info which is important to determining equality
  var newDateWithTime = createNewDateWithTime(newDate, endDate.hour(), endDate.minute());
...
var createNewDateWithTime = function createNewDateWithTime(newDate, hour, minute) {
