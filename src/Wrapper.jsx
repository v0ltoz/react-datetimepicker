...
class Wrapper extends React.Component {
    ...
    renderVanillaPicker(ranges, local, maxDate) {
        ...
        return (
            <div>
                ...
                <div>
                    Local settings chosen for this demo are = "DD-MM-YYYY HH:mm" with Monday the first day of the week{' '}
                </div>
                <br />
        ...
        return (
            <>
                <div onClick={this.onClick}>
                    {' '}
                    Click Me to test the Date Picker in Mobile Mode disabled. Normally it would be in condensed form at
                    this size.
                </div>
                <br />
    ...
    renderGridPickerForceMobileMode(ranges, local, maxDate) {
        ...
        return (
            <>
                <div onClick={this.onClick}>
                    {' '}
                    Click Me to test the Date Picker in Mobile Mode forced. Normally it would be in full screen form at
                    this size.
                </div>
                <br />
                <DateTimeRangeContainer
    ...
    renderPickerAutoApplySmartModeDisabled(ranges, local, maxDate, descendingYears) {
        ...
        return (
            <div id="DateTimeRangeContainerSmartModeDisabled">
                ...
                <div onClick={this.onClick}>
                    Click Me to test the Date Picker with Auto Apply, Custom dates, Smart Mode disabled and descending
    ...
    renderPickerAutoApplySmartModeDisabledSecondsIncluded(ranges, local, maxDate, descendingYears) {
        let value = `${this.state.start.format('DD-MM-YYYY HH:mm:ss')} - ${this.state.end.format(
            'DD-MM-YYYY HH:mm:ss'
        )}`;
        local = {
    ...
    renderPickerSmartModeDisabledCustomStyling(ranges, local, maxDate, descendingYears) {
        ...
        return (
            <div id="DateTimeRangeContainerCustomStyles">
                ...
                <div onClick={this.onClick}>
                    Click Me to test the Date Picker with Custom Styling and descending years set to{' '}
    ...
    renderPickerAutoApplyPastFriendly(ranges, local, maxDate, descendingYears) {
        ...
        return (
            <div>
                ...
                <div onClick={this.onClick}>
                    Click Me to test the Date Picker in Past Search Friendly mode with auto apply with custom dates and
                    descending years set to {descendingYears.toString()}
                </div>
                <br />
            </div>
        );
