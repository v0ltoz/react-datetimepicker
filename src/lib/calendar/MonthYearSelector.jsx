    ...
    render() {
        ...
        return (
            <div className="m-1 mt-2 flex items-center">
                ...
                <div className="grow" onFocus={this.monthFocus} onBlur={this.monthBlur} style={monthFocusStyle}>
                    <select
                ...
                <div className="grow" onFocus={this.yearFocus} onBlur={this.yearBlur} style={yearFocusStyle}>
                    <select
